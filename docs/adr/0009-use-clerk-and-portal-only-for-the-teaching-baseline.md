...
The application uses stable `general` and `announcements` channels. It renders Portal hook state directly and mounts only the selected channel, using the Portal inbox for inactive-channel attention.
